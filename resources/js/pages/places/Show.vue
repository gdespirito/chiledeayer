...
import type { BreadcrumbItem, PaginatedData, Photo, Place } from '@/types';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-6 p-4">
            <div class="space-y-2">
                ...
                <p
                    v-if="props.place.data.region || props.place.data.city"
                    class="text-sm text-muted-foreground"
                >
                    {{
                        [
                            props.place.data.city,
                            props.place.data.region,
                            props.place.data.country,
                        ]
                            .filter(Boolean)
                            .join(', ')
                    }}
                ...
                <p class="text-sm text-muted-foreground">
                    {{ props.place.data.photos_count ?? 0 }}
                    {{
                        (props.place.data.photos_count ?? 0) === 1
                            ? 'foto'
                            : 'fotos'
                    }}
                </p>
            ...
            >
                <p class="text-sm text-muted-foreground">
                    Este lugar no tiene fotos todavia.
                </p>
            </div>
