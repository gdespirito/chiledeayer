...
import type { BreadcrumbItem, PaginatedData, Photo, Tag } from '@/types';
...
<template>
    <Head :title="props.tag.data.name">
        <meta
            head-key="description"
            name="description"
            :content="`Fotografías históricas etiquetadas con ${props.tag.data.name}. Archivo fotográfico de Chile.`"
        />
        <meta
            property="og:title"
        ...
        <div class="flex flex-1 flex-col gap-6 p-4">
            <div class="space-y-2">
                ...
                <p class="text-sm text-muted-foreground">
                    {{ props.tag.data.photos_count ?? 0 }}
                    {{
                        (props.tag.data.photos_count ?? 0) === 1
                            ? 'foto'
                            : 'fotos'
                    }}
                </p>
            ...
            >
                <p class="text-sm text-muted-foreground">
                    Esta etiqueta no tiene fotos todavia.
                </p>
            </div>
